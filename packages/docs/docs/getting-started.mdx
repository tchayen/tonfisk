...
> NOTE: I am planning to provide alternative bundle with all CSS packed together.
> Pros: would allow people to use `tonfisk` without setting up `vanilla-extract (CRA).
> Cons: wouldn't allow for tree-shaking the CSS.
